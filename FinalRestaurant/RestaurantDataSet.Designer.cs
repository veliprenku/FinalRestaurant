...
namespace FinalRestaurant {
    ...
    public partial class RestaurantDataSet : global::System.Data.DataSet {
        ...
        public partial class productsDataTable : global::System.Data.TypedTableBase<productsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public productsRow AddproductsRow(string pName, double pPrice, int CategoryID) {
        ...
        public partial class staffDataTable : global::System.Data.TypedTableBase<staffRow> {
            ...
            private void InitClass() {
                ...
                this.columnsPhone.MaxLength = 30;
                this.columnsRole.AllowDBNull = false;
                this.columnsRole.MaxLength = 30;
            }
...
namespace FinalRestaurant.RestaurantDataSetTableAdapters {
    ...
    public partial class categoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FinalRestaurant.Properties.Settings.Default.RestaurantConnectionString;
        }
    ...
    public partial class productsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[products] WHERE (([pID] = @Original_pID) AND ([pName] = @Origi" +
                "nal_pName) AND ([pPrice] = @Original_pPrice) AND ([CategoryID] = @Original_Categ" +
                "oryID))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[products] ([pName], [pPrice], [CategoryID]) VALUES (@pName, @p" +
                "Price, @CategoryID);\r\nSELECT pID, pName, pPrice, CategoryID FROM products WHERE " +
                "(pID = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[products] SET [pName] = @pName, [pPrice] = @pPrice, [CategoryID] = @CategoryID WHERE (([pID] = @Original_pID) AND ([pName] = @Original_pName) AND ([pPrice] = @Original_pPrice) AND ([CategoryID] = @Original_CategoryID));
SELECT pID, pName, pPrice, CategoryID FROM products WHERE (pID = @pID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT pID, pName, pPrice, CategoryID FROM dbo.products";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_pID, string Original_pName, double Original_pPrice, int Original_CategoryID) {
            ...
            this.Adapter.DeleteCommand.Parameters[2].Value = ((double)(Original_pPrice));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string pName, double pPrice, int CategoryID) {
            if ((pName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string pName, double pPrice, int CategoryID, int Original_pID, string Original_pName, double Original_pPrice, int Original_CategoryID, int pID) {
            if ((pName == null)) {
                throw new global::System.ArgumentNullException("pName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((double)(Original_pPrice));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string pName, double pPrice, int CategoryID, int Original_pID, string Original_pName, double Original_pPrice, int Original_CategoryID) {
            return this.Update(pName, pPrice, CategoryID, Original_pID, Original_pName, Original_pPrice, Original_CategoryID, Original_pID);
        }
    }
    ...
    public partial class staffTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[staff] WHERE (([staffID] = @Original_staffID) AND ([sName] = @" +
                "Original_sName) AND ([sPhone] = @Original_sPhone) AND ([sRole] = @Original_sRole" +
                "))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[staff] SET [sName] = @sName, [sPhone] = @sPhone, [sRole] = @sRole WHERE (([staffID] = @Original_staffID) AND ([sName] = @Original_sName) AND ([sPhone] = @Original_sPhone) AND ([sRole] = @Original_sRole));
SELECT staffID, sName, sPhone, sRole FROM staff WHERE (staffID = @staffID)";
        ...
        public virtual int Delete(int Original_staffID, string Original_sName, string Original_sPhone, string Original_sRole) {
            ...
            if ((Original_sPhone == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[2].Value = ((string)(Original_sPhone));
            }
            if ((Original_sRole == null)) {
                throw new global::System.ArgumentNullException("Original_sRole");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_sRole));
            }
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.DeleteCommand.Connection.State;
            if (((this.Adapter.DeleteCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
        ...
        public virtual int Insert(string sName, string sPhone, string sRole) {
            ...
            if ((sRole == null)) {
                throw new global::System.ArgumentNullException("sRole");
            }
            else {
        ...
        public virtual int Update(string sName, string sPhone, string sRole, int Original_staffID, string Original_sName, string Original_sPhone, string Original_sRole, int staffID) {
            ...
            if ((Original_sPhone == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_sPhone));
            }
            if ((Original_sRole == null)) {
                throw new global::System.ArgumentNullException("Original_sRole");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_sRole));
            }
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[users] SET [username] = @username, [upass] = @upass, [uName] = @uName, [uphone] = @uphone WHERE (([userID] = @Original_userID) AND ([username] = @Original_username) AND ([upass] = @Original_upass) AND ([uName] = @Original_uName) AND ([uphone] = @Original_uphone));
